...
} from './middleware/better-auth.middleware.ts';
export { BetterAuthConfig } from './better-auth.config.ts';

export { AUTH_SESSION_KEY, AUTH_USER_KEY, DEFAULT_AUTH_BASE_PATH } from './constants.ts';
...
export type { BetterAuthMiddlewareOptions } from './interfaces/better-auth-middleware-options.interface.ts';
export type { AuthRouteHandler, AuthRouteHandlerWrapper } from './types/auth-route-handler.ts';
