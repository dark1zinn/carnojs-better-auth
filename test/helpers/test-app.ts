import { type CorsConfig, type TestHarness, type TestOptions, withTestApp } from '@carno.js/core';
...
async function resolveTestHelpers(auth: BetterAuthService): Promise<TestHelpers> {
...
export async function withAuthApp(
    ...
    const { authOptions = createTestAuthOptions(), cors, config, ...harnessOptions } = options;
